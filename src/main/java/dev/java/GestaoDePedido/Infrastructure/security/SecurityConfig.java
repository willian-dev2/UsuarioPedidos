    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/auth/login").permitAll() // Permite acesso ao endpoint de login sem autenticação
                        .requestMatchers(HttpMethod.GET, "/usuario/auth").permitAll()// Permite acesso ao endpoint GET /auth sem autenticação
                        .requestMatchers(HttpMethod.POST, "/auth/registro").permitAll() // Permite acesso ao endpoint POST /usuario sem autenticação
